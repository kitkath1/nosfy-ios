...
-- depuis Woop/Models.swift (ExerciseCatalog.all), le 2026-09-15 : 29 exercices.
--
...
insert into public.exercices (id, nom, categorie, equipement, tracking, muscle, consigne, erreur) values
  ...
  ('hiit-tapis', 'HIIT sur tapis de course', 'Cardio', 'machine', 'intervals', 'Cardio-respiratoire', 'Tu alternes des passages rapides et des récupérations, le buste droit, sans toucher les barres.', 'Partir trop vite sur le premier passage et s''écrouler sur les suivants.'),
  ('escalier', 'Escalier', 'Cardio', 'machine', 'steady', 'Fessiers et cardio', 'Tu montes en continu, le pied entier sur la marche, le buste droit.', 'Se suspendre aux poignées, ce qui annule le travail des jambes.'),
  ('tapis-lent', 'Tapis à allure modérée', 'Cardio', 'machine', 'steady', 'Endurance fondamentale', 'Tu tiens une allure où tu peux encore parler, longtemps, sans forcer.', 'Monter l''allure jusqu''à ne plus pouvoir tenir la durée.'),
  ('piscine', 'Piscine', 'Cardio', 'poidsDuCorps', 'steady', 'Cardio-respiratoire et corps entier', 'Tu nages à allure régulière, le corps aligné à la surface, la respiration calée sur les bras.', 'Lever la tête pour respirer : le bassin descend et les jambes traînent.')
