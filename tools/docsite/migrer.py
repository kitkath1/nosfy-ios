...
PREUVES = {
    ...
    'workouts': ('Nosfy/Services/SupabaseSync.swift', '113-116'),
    'logged_exercises': ('Nosfy/Services/SupabaseSync.swift', '113-116'),
    'strength_sets': ('Nosfy/Services/SupabaseSync.swift', '113-116'),
    ...
    'cloturer_seance': ('Nosfy/Services/SacreServeur.swift', '185'),
    'etat_coffre': ('Nosfy/Services/SacreServeur.swift', '77'),
    'historique_gains': ('Nosfy/Services/SacreServeur.swift', '351'),
    'claim_booster': ('Nosfy/Services/SacreServeur.swift', '297'),
    'ouvrir_booster': ('Nosfy/Services/SacreServeur.swift', '329'),
    'claim_retour_quotidien': ('Nosfy/Services/SacreServeur.swift', '143'),
    'reclamer_noeud_chemin': ('Nosfy/Services/SacreServeur.swift', '278'),
    'noeuds_chemin_reclames': ('Nosfy/Services/SacreServeur.swift', '380'),
    ...
    'solde_argent': ('Nosfy/Services/SacreServeur.swift', '99'),
    'claim_booster_legendaire': ('Nosfy/Services/SacreServeur.swift', '109'),
    'solde_noir': ('supabase/migrations/20260828120000_booster_noir.sql', '191'),
    'forge-card': ('Nosfy/Services/ForgeServeur.swift', '45'),
    'weekly-synthesis': ('Nosfy/Services/SynthesisService.swift', '109'),
}
REGLES_PREUVE = {
