...
import json
p=Path('/private/tmp/woop-home22-reference-142933-cpu-time-profile.xml')
...
Path('/private/tmp/woop-home22-reference-142933-cpu-analysis.json').write_text(json.dumps(meta,indent=2))
Path('/private/tmp/woop-home22-reference-142933-cpu-resolved-samples.json').write_text(json.dumps(samples))
