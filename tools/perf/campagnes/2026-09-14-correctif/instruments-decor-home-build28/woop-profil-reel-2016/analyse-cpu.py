...
import json
p=Path('/private/tmp/woop-profil-reel-2016/cpu-time-profile.xml')
...
Path('/private/tmp/woop-profil-reel-2016/cpu-analysis.json').write_text(json.dumps(meta,indent=2))
Path('/private/tmp/woop-profil-reel-2016/cpu-resolved-samples.json').write_text(json.dumps(samples))
