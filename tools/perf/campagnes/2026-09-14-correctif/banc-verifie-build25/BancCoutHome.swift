...
final class BancCoutHome {
    ...
    func executer() async {
        ...
        do {
            ...
            // L'onglet Home ne prouve pas l'absence d'une pop-up au-dessus.
    ...
    private var contexteValide: Bool {
        UIApplication.shared.applicationState == .active
            ...
            && !DepartEtat.shared.welcomeOuverte
            && !DepartEtat.shared.welcomePremiereOuverte
            && !CompteEtat.shared.enPorte
            && !SacreEtat.shared.popupOuverte
