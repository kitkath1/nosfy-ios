...
out=Path('/private/tmp/woop-sonde30'); out.mkdir(exist_ok=True)
...
try:
 ...
 print('Home complète : relevé35s',flush=True); time.sleep(35)
finally:
 launch('retour-normal-sans-sonde')
run('collecte',['python3','/private/tmp/woop-collect-id22.py','woop-sonde30','--nav'],35)
