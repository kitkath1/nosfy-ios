...
import json
p=Path('/private/tmp/woop-profil9-time-profile.xml')
...
Path('/private/tmp/woop-profil9-cpu-analysis.json').write_text(json.dumps(meta,indent=2))
Path('/private/tmp/woop-profil9-resolved-samples.json').write_text(json.dumps(samples))
