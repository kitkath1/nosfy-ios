...
import json
p=Path('/private/tmp/woop-home21-precompose-120934-cpu-time-profile.xml')
...
Path('/private/tmp/woop-home21-precompose-120934-cpu-analysis.json').write_text(json.dumps(meta,indent=2))
Path('/private/tmp/woop-home21-precompose-120934-cpu-resolved-samples.json').write_text(json.dumps(samples))
