...
out=Path('/private/tmp/woop-balade30'); out.mkdir(exist_ok=True)
...
try:
 ...
 print('Home après balade : observation35s',flush=True);time.sleep(35)
finally:
 launch('retour-normal-sans-sonde')
run('collecte',['python3','/private/tmp/woop-collect-id22.py','woop-balade30','--nav'],35)
