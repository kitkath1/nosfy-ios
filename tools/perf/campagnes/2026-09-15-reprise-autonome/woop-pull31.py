...
out=Path('/private/tmp/woop-pull31'); out.mkdir(exist_ok=True)
...
try:
 launch('home-rendu',True)
 ui('pull-chapitre','testRetourPullEtChapitre')
 run('collecte-nav',['python3','/private/tmp/woop-collect-id22.py','woop-pull31','--nav-only'],35)
finally:
 launch('home-normale')
