...
struct ProfilLuneView: View {
    ...
    /// LE CRAN DU COFFRE à l'ouverture (15-09, verdict : « au clic des 4
    /// pastilles liquid glass ça ramène sur la page coffre au bon item ») :
    /// 0 l'or · 1 le sachet Lune · 2 l'argent · 3 le noir — l'ordre du
    /// manège (`CoffreV2Page.variantes`). Posé par la pastille touchée,
    /// juste avant `showCoffre`.
    @State private var coffreItem = 0
    ...
    /// La porte du coffre depuis une pastille : le cran d'abord, la page
    /// ensuite (`fullScreenCover` lit `coffreItem` à la montée).
