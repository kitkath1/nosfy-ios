...
| **CGU visibles dans l'app** | `Nosfy/Views/ProfilLune.swift:2059` contient encore « Le texte des conditions générales sera rédigé avant la publication sur l'App Store. » | Remplacer le texte d'attente par le contenu final approuvé et vérifier son affichage. App Store Connect et ses déclarations n'ont pas été inspectés ici. |
