#!/bin/zsh
# LA FIN « END » (13-09) — Woop/Media/nosfy-end.mp4 + poster, depuis ~/Downloads/end.mp4
...
set -e
SRC="$HOME/Downloads/end.mp4"; OUT="Woop/Media/nosfy-end.mp4"
POSTER_DIR="Woop/Assets.xcassets/nosfy-end-poster.imageset"
