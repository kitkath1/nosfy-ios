...
export function GalerieCartes() {
  return (
    <section className={styles.galerie} aria-label="Les illustrations retenues des trois familles">
      ...
      <p>14 illustrations publiées sur une cible de 50 scènes communes. Les 36 suivantes restent des propositions, sans génération. Shiny très marqué demandé ; animation et contraste iPhone encore à vérifier.</p>
      {families.map(family => (
