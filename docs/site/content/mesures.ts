...
export const MESURES: Mesure[] = [
  ...
  { id: "m-trancher-la-conversion-automatique", titre: "Trancher la conversion automatique pièces → sachets", page: "regles", domaine: "eco", lecture: "inconnu", cout: "1 j", note: "TRANCHÉ le 30-08 : à 100 pièces un sachet apparaît tout seul, les pièces retombent (PLAN-COFFRE-ANNONCES.md §4 M1) — reste à ÉCRIRE et à mesurer", preuve: { fichier: "docs/screens/coffre-rewards.md", lignes: "287-292" } },
  { id: "m-trancher-le-fuseau-du", titre: "Trancher le fuseau du « jour » (UTC vs profil)", page: "serveur", domaine: "eco", lecture: "inconnu", cout: "1 j", note: "TRANCHÉ le 30-08 : minuit chez elle, pas UTC — une clé serveur fuseau_jour = Europe/Paris, jamais le fuseau du téléphone (PLAN-COFFRE-ANNONCES.md §4 M1) — reste à écrire et à mesurer", preuve: { fichier: "Woop/Services/SacreServeur.swift", lignes: "248-253" } },
