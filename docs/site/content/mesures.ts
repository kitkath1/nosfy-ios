...
export const MESURES: Mesure[] = [
  {"id": "m-home-voix-fr-en", "titre": "Confirmer les mots animés et l’haptique sur iPhone", "page": "widgets", "domaine": "widgets", "lecture": "inconnu", "cout": "chantier", "note": "16-09 : backend FR/EN publié et vérifié, lots courts 03 embarqués, Release 37 installée. Le rendu 36 a été rejeté : effet de parole insuffisant. 37 reprend le phrasé onboarding, flou mot par mot et haptique soft, puis repos. Films simulateur rouge/noire FR/EN vérifiés ; lancement iPhone 37 refusé Locked. Rendu sur les deux Homes, haptique, navigation et coût après lecture restent à confirmer ; aucune validation thermique longue.", "preuve": {"fichier": "tools/home-v2/BILAN-TEXTES-HOMES-2026-09-16.md"}},
