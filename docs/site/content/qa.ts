...
export const ETAPES_QA: EtapeQA[] = [
  ...
  {"id": "qa-18-chauffe-parcours", "n": 18, "titre": "Chauffe : Profil, stories, manège, carte et séance", "geste": "Depuis un iPhone nominal, parcourir Profil, stories complètes, manège3D et carte, puis revenir à l’accueil plusieurs minutes ; rejouer avec séance en cours et écouteurs. Interrompre le stress si iOS atteint serious.", "front": "Gestes et rendu conservés, moteurs rendus hors écran, récupération sans charge persistante après fermeture.", "back": "Aucune séance ni ouverture de booster de production créée par le diagnostic ; historique et écouteurs conservés.", "frontVerdict": {"etat": "ko", "le": "18-09", "note": "18-09 après redémarrage, sans écouteurs :76 repart nominal mais le parcours est interrompu par la suspension système de l’app. Profil actif34s, puis reprise à chaud ; thermique2 et sachet encore30Hz malgré protection1. Arrêt explicite et sonde désactivée. Correctif78 en préparation : pose du décor3D, halos et avatar au repos à chaud, gestes conservés.78 non installé ; chauffe durable, séance prolongée et écouteurs toujours ouverts. tools/perf/campagnes/2026-09-18-chauffe76-apres-reboot/etat.md"}, "backVerdict": {"etat": "a_valider", "note": "Campagne locale de rendu ; aucune validation backend ou de gains déduite."}},
]
