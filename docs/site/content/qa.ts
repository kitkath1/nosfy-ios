...
export const ETAPES_QA: EtapeQA[] = [
  ...
  },
  {
    ...
    frontVerdict: {"etat": "ko", "le": "15-09", "note": "15-09,21:55 : build30 Release installé ; navigation PASS9,267s. Chevrons pull to start passés à Core Animation, mouvement et flammes vérifiés sur8 captures XCTest. Mesure30 :1 % CPU,60,1 callbacks/s,17ms max, mais thermique1/protection1 : aucun gain animé prouvé. Sur29 froid, retirer l’invitation donne3→1 % (20 relevés,15<t≤35s), ce qui motive le correctif. Verre conservé : Power Profiler28 à froid4,962 % avec contre4,897 % sans, aucun gain clair des scores disponibles, pas de watts. Dernier retour utilisateur sur30 : ça chauffe beaucoup moins ; amélioration nette confirmée, tenue prolongée encore non validée. QA04 reste ouverte (KO). Home normale restaurée21:54:42, compteurs éteints ; branchement pendant le retour non précisé. Aucun cycle complet du compte. Preuves : tools/perf/campagnes/2026-09-14-correctif/chevrons-natifs-build30/etat.md ; registre51 entrées. Concession visuelle signalée ensuite par Kathryn : fond liquide et liseré tournant du Chapitre retirés, halo figé même à froid. Design animé complet non restauré ; baisse de chauffe ne signifie pas rendu intégralement conservé (E50)."},
  ...
  },
  {
    ...
    frontVerdict: {"etat": "valide", "le": "15-09", "note": "Build30 Release installé à21:51:44, UUID8CFBC1D4-0B4B-3725-AD2A-C74F1000E4B8. Home → Exercices → Home → Profil → Réglages PASS9,267s sur l’iPhone réel. Aucun appui Se déconnecter ou Supprimer mon compte. Valide l’accès aux écrans ; chauffe et cycle complet du compte non validés. Preuve : tools/perf/campagnes/2026-09-14-correctif/chevrons-natifs-build30/validation30/navigation.log."},
