...
export const ETAPES_QA: EtapeQA[] = [
  ...
  },
  {
    ...
    frontVerdict: {"etat": "ko", "le": "16-09", "note": "16-09, reprise 11:09 : 37 lancée, Home/Exercices/Profil/Réglages PASS 10,754 s ; trois retours du pull puis Profil PASS 36,242 s. Home rouge : CPU médian 1 % sur 128 lignes, 124 protégées et seulement 4 nominales. 38 installée/lancée 11:17, parole Home noire séparée du repos thermique des décors ; chrono/texte concordants. Banc noir : CPU médian 2,5 % sur 150 lignes, toutes thermique 1/protection 1. Faible CPU protégé ne valide pas le rendu normal ni la chauffe durable ; QA04 reste ouverte, aucun cycle nouveau compte. Sonde arrêtée et Home normale rétablie 11:20. Preuves : tools/home-v2/validation-textes-2026-09-16/reprise-1109/etat.md."},
  ...
  },
  {
    ...
    frontVerdict: {"etat": "valide", "le": "16-09", "note": "16-09 : parcours 37 Home → Exercices → Home → Profil → Réglages PASS 10,754 s ; trois retours du pull puis Profil/Home PASS 36,242 s. Version 38 installée/lancée, quatre cycles Exercices/Profil contrôlés dans le bilan de reprise. Aucun appui Se déconnecter/Supprimer mon compte, aucune séance créée. Cette validation porte sur l’accès ; cycle du compte et chauffe prolongée restent ouverts. Preuves : tools/home-v2/validation-textes-2026-09-16/reprise-1109/etat.md."},
