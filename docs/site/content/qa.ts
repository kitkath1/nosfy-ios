...
export const ETAPES_QA: EtapeQA[] = [
  ...
  },
  {
    ...
    frontVerdict: { etat: 'ko', le: '14-09', note: 'VALIDÉ par elle deux fois (fr le matin, en l\'après-midi) : « j\'arrive bien sur la home vide, nickel avec la bonne langue, le bon nom, tout est empty même les widgets » ; 2e passage : « les étapes 1 à 6 sont ok niveau front et back ». KO : le lag — « tout s\'affiche hyper lentement, quasi impossible de naviguer dans l\'app, c\'est insupportable » (téléphone chaud, build Debug) ; mesuré froid : 50 img/s · pire 47 ms · cpu 30 % ; chaud (therm 2) : bridé. Chantier perf : Release + audit + campagne froide' },
  ...
  },
  {
    ...
    frontVerdict: { etat: 'ko', le: '14-09', note: 'deux passages, même mur : « je ne peux pas accéder à partir du point 7 — tout s\'affiche hyper lentement, quasi impossible de naviguer, c\'est insupportable » (téléphone chaud, build Debug). Le chemin du tap est le même que les deux autres onglets ; au simulateur la page rend « Jetable », rond « J », « @jetable » (capG4). Bloqué par la performance. MESURÉ 15:54 sur son iPhone, Release lancée À LA MAIN sans câble, thermique 2 : 25 s à 48-60 img/s puis 40 s à 6-18 img/s avec 2-13 % de cpu (le fil principal ATTEND, il ne calcule pas) — dossier tools/perf/BUG-CHAUFFE-GEL-HOME.md ; son ordre : documenter, ne pas corriger' },
