...
export const ETAPES_QA: EtapeQA[] = [
  ...
  },
  {
    ...
    frontVerdict: {"etat": "ko", "le": "16-09", "note": "16-09,07:30 : Release35 installé, numéro réel relu sur iPhone. Deux tentatives XCTest échouent avant tout geste : Timed out while enabling automation mode.269 lignes après15s sous Welcome Back, puis app inactive : aucune nouvelle mesure de Home35 exploitable. Lancement Profil avec compteurs éteints accepté07:36:24 ; affichage interactif non confirmé. Dernières preuves34 du15-09 : CPU Home médian1 % sur180,7s (164 lignes,76 nominales et88 protégées), onde du Chapitre et souffle du point natif conservés ; navigation et4cycles Exercices/Profil PASS. Après balade34, récupération CPU1 % mais thermique1. Chauffe durable, rendu/parcours35 et cycle nouveau compte restent à confirmer : QA04 ouverte. Skill woop-chauffe créé, analyseur vérifié ; registre57 entrées. Preuves : tools/perf/campagnes/2026-09-16-validation35/etat.md et campagne2026-09-15-reprise-autonome."},
  ...
  },
  {
    ...
    frontVerdict: {"etat": "valide", "le": "15-09", "note": "Accès validé sur34 le15-09 : Home → Exercices → Home → Profil → Réglages PASS9,231s ;4cycles Exercices/Profil PASS66,481s ;3retours du pull puis Profil PASS35,164s. Le16-09,35 est installé, mais XCTest ne parvient pas à activer le mode automatisation ; aucun nouveau parcours35 exécuté. Lancement direct Profil accepté, app ensuite inactive : pas une validation tactile. Aucun appui Se déconnecter/Supprimer mon compte, aucune séance démarrée. Cycle du compte et chauffe durable restent ouverts. Preuves : tools/perf/campagnes/2026-09-16-validation35/etat.md ; validations34 dans campagne2026-09-15-reprise-autonome."},
