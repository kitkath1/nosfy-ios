...
enum Compte {
    ...
    static func proposerWelcomeBack() {
        ...
        // LA ROBE, ALTERNÉE À CHAQUE OUVERTURE (son verdict 20-09) : la robe
        // actuelle (vidéo) puis celle à gros texte (« You Made It »), et ainsi
        // de suite. Le choix est posé ICI, une fois — jamais dans un body.
        let prochaineTexte = UserDefaults.standard.bool(forKey: cleWelcomeRobeTexte)
        depart.welcomeRobe = prochaineTexte ? .texte : .video
